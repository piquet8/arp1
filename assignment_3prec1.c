    ...
    for (int count = 0; count < 10; count++)
    {
        ...
        if (turnLeader == true)
        {
            ...
            if (count == 9)
            {
                ...
                float totBand = ((float)(8*sizeof(message_t)) / ((averageTotTime.tv_sec*1000000) + (averageTotTime.tv_usec)));
                float flyBand = ((float)(8*sizeof(message_t)) / ((averageFlyTime.tv_sec*1000000) + (averageFlyTime.tv_usec)));
