...
// Declare functions
void handshake_function();
void vote_function();
void turn_function(message_t* msg);
    ...
    for (int count = 0; count < 10; count++)
    {
        ...
        if (turnLeader == true)
        {
            ...
            if (count == 9)
            {
                ...
                averageTotTime.tv_sec = (averageTotTime.tv_sec/1000000);
                averageTotTime.tv_usec = (averageTotTime.tv_usec/1000000);
                averageFlyTime.tv_sec = (averageFlyTime.tv_sec/1000000);
                averageFlyTime.tv_usec = (averageFlyTime.tv_usec/1000000);
                ...
                float totBand = ((float)(8*sizeof(message_t)) / (averageTotTime.tv_sec + (averageTotTime.tv_usec/1000000)));
                float flyBand = ((float)(8*sizeof(message_t)) / (averageFlyTime.tv_sec + (averageFlyTime.tv_usec/1000000)));
